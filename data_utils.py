...
class EmotionDataset(Dataset):
    def __init__(self, train, hparams, device, transform=None):
        ...
        # try:
        #     self.spec_aug = hparams.data.spec_aug
    ...
    def __getitem__(self, idx):
        ...
        # segments = extract_resized_segments_from_file(wavpath, device=self.device, normalizer=self.transform, max_sec=self.max_sec, spec_aug=self.spec_aug)
